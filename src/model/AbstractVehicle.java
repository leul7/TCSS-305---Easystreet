/*
 * Leul Amare TCSS 305 Assignment 3 - easystreet.
 * 
 */
...
/**
 * This class represents the abstract vehicle parent class that has multiple
...
public abstract class AbstractVehicle implements Vehicle {
    ...
    /** Previous Direction. */
    protected Direction myPreviousDirection;
    /** X value. */
    protected int myX;
    /** Y value. */
    protected int myY;
    ...
    public void collide(final Vehicle theOther) {
        if (this.getDeathTime() > theOther.getDeathTime()) {
            /*
             * If this vehicles death timer is less than the other vehicles death timer then
             * this vehicle dies.
             */
            this.myAlive = false;
        } else {
            /*
             * Else, stay alive this is a redundant else but ensures the vehicles definitely
             * stays alive.
             */
            this.myAlive = true;
        }
